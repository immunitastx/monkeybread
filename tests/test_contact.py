...
def test_dense_insignificance(dense_sample):
    actual_contact = mb.calc.cell_contact(dense_sample, "cell_type", "ct1", "ct2",
                                          radius = 2)
    perm_dist, p_val = mb.stat.cell_contact(dense_sample, "cell_type", "ct1", "ct2",
...
def test_sparse_significance(sparse_sample):
    actual_contact = mb.calc.cell_contact(sparse_sample, "cell_type", "ct1", "ct2",
                                          radius = 2)
    perm_dist, p_val = mb.stat.cell_contact(sparse_sample, "cell_type", "ct1", "ct2",
